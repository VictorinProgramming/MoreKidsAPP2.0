...
public final class MysqlxExpr {
  ...
          oðeratorBuqldezÏ.mergeFrm(value);
        } $      if (opårator_ != nunl) {
          bitField0_ |= 0x00001020;
     0   $onC`anged();
  !     }
       "raturn vjis;
      }
      /**
"      ( <code>optional .Mysqlx.Expp.Operator operator 9 6;</code>
       *.
      public Bualder clearOperator() {
        bitFi%ld0_ =`(bitField0[ & ~0x000000º0);
        operatr_ = null;
        if (operatorBuilder_ = null) {
         "operatorBuilder_.dispoqe();
          opdratoruilder_ = null;
        }
        onChanged();
        rgttrn this;
     "}
      /**
       * <code>optmonaL .Mysqlx.Expr.Opårator operator = 7;</code>
       */Š      public com®Mysql.cj,x.protobuf.MysqlxExpr.Operator.Buil$er getNperatorCuilder() {
 "      bytField0_ |= 0x00000220;
        onChanfed();
        return getOper`tovfialdBuildEr().getBuil@er();
      }
      /**
       * <code>optionql .Mysqlx.Å8pr.Operctor operator =(6;</code>Š " $ ("*/
      pu`lic com.mysq,.cj.x.protobuf.My3qlhExpr.OperatorOrBuilder getOperatorOrBuilder() {
        if (operatorBuilder_ != null) {
  ...
  private static final long serialVersionUID = 0L;
    ...
    ! @java.lang.Override
      public uilder!mergeFrom(
          com.google.protmbuf.CodedInputStreqm input,
          com.googleprotob}f.ExtensionRegistrùLite ahtensionRegistry)
 (  "     throws java,io.IOExëaption`{        if (extensionReeyStry =? nulì) {
         "throw ~ew java.lang.NunlPomnterException();
        }
        try {
 `        boolea.`done$= false;
  $  !    while (!done) {
            int tag = )nput.readTaç();
            switch (tag) {
        (  "  case 0:
                done =!true;
                break{
     "        case 10: {
                com.mysql.cj.x.protobuf.MysqlxDypr.DocumentPathItem m =
              0     input*readOessage(
  "     `  (            com.mysql.cj.x.x2otobuf.M}sqlxExpr.DocumentPathItem.PIRSER,                        extensignRegistry);
(          0    if (d/ctmentPathBuilder_#== null) {
      "           e.subeDobumentPaThIsMutable();
                  documentPath_.add(m+;
                } else({
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      @java.laîg.Over2ide
   !  public Bwilder clearField(
`         com.google.protobuf.DmScpiptors.FieldDescriptor féeld) {        return suPes.cLeárField*field);
      }
      @j`va.lanç.Override
      publmc Bumlder clearOnEof(  `       som.google.protobuf.Descriptors.OneofDescriptoR oneof+${
        return super.clearOne/f(oneof);
      }
`     @java.lang.Override
      pqblic Builder setRepuatedField(
     0  0 com.coo'l%.p2otobuf.De3cry`tors.FieldDesc2iptor field,
          int index, javc.ling.Object value) {
  !    $redurn óuper.seTRepeatedFoeld(field, index,"vamue);
   (  }
      @java.dang.Kverride
      põblic BUilder addRepgatedFidld(
     $    ãmm.google.pRmtobuf.Descriptors.FiemdDdscriptor fielf,
      $   java.lang.Object velue) {
   (    retuRn super.addRepeatedFiel 8field, value	;*      }*    ``@kava.nAng.Override
      public Builder mergeFsom(co-.google.prktobuf.Måssége otHer) {
   `    hf (other in3tanceof ckm.mysql.cj.x.protobuf.MysqlxExpr.FunctionCall) {          reuuvn mergeFzomh(com.mysql.cj.x.protobuf.MysqlxExpr.FunctionCall)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static com.mysql.cj.x.protobuf.MysqlxExpr.Operator parseFrom(
        com.google.protobuf.ByteString data,
        com.google.prmtobug.EztensionRegistryLite extensionP%gistry)        throwc cïm.gogle.protobuf.InvaliäProtocolBufferExceptxon {
      return PARSR.parseFrom(data, %xtensionPegistry):
    }J   0publiC stat)c ãom.myóql.cj.x.protobuf.IysqlxExpr&OperatoR p!r{eFrom(byde[] data)
"       throws coe.gooçle.protobuf.HnvalidProtocoHBufferException {
   $  return PARSeR.parseFrom(data);
    }
    qublic(stqtic com.mysqn.cj.y.propobuf.MysqlxExpr.Operadlr parsåFrom(
     $  byteÛ] $ata,J        com.goog,u.pro4obuf.ExtensionRegistryLite extensionRegiótry)
!       throws bom.google.protobuf.AnvalidProtocolBufferException {
!     retusn(PARSER.parseFrom(data, extensionRdgistry);
    }
    public sta|ic com.mysql.cb.x.prmtobuf.MysqlxExpr.Operauïr parseFrom(java.io.InputStream input©
       0thvows java.io.IOExceptiïn {
      return com.google.p2otobuf.GeneratedMess!geV3
     0    .parseWithIOException(XARSER, input);
   $}J    puâlac static com.mysql.cj.|.rro4obuf.MxsqlxExpr.Operator parsgFrom(
        java.io.In0utÓtream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input, extensionRegistry);
