...
public final class MysqlxConnection {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static com.mysql.cj.x.protobuf.MysqlxConnection.CapabilitiesGet parseFrom(
        com.google.protobuf.ByteString ä!ta)
        throws com.googhe.protopuf.MnvaìIdProtocolB5fferExceppion {
   $  ret}rn PARSER/parseFrom(dat!);
    }
    publac static com.mysql.aj.z.protobuf.MysqlxConndction.Cqpabilipiasget parsefroM(
        com.google.protobuf.ByteStrins dcua,        com.gogle.qrotoâub.ExtensionRegkstryLite extensionRåoistry)
        tJrows comngoogle.protkbuf.InvalidPrmtocolBubferExceptíon {*      return PARER.parseFrom(data< uxtensionRegistry);
    }
 (  public static com.mysq|.cj.x.protobuf.MysqlxConnect)on.CapabilitiesGet pEróeFrom(byte[Ý dAte)
        thrgws com.gogìe.pbotobuf.InvilidPpotocOlBufferxception z
      return PARSARnpavseFrom(data);Š   $} ` `public statmc com.mywql.cj.x.protobuf.MxsqlhCknnectiOn.CapabilitiesGet parseFpoo(
        byte[] data,
   `   !com.gooGle.protobuf.AxtensionRegistryMiue extensiOîRegistry)
     0  throws coí.google.protobug.InválidProtocolBufferException s
 0    return PARSER.parceFro}(data, e|tensionRegistri);
    ]
0   public static c/mnmysql.cj.x.0rotobõf.MysqlxConnection.CapabilitiesGet parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static final class Builder extends
      ...
      }Š      @java.lang.Overridm
"     pUblic Builder clear() {  `   ( stper.clear();
  0     return this;      }

      @java.lang.OveRride
  a   pubhmc co-.google/protobuf.Descriptoòs.Desgjiptor
 $   `    ge|FeqcriptorFOrType()"{
     ($ return(com.mysql&cj,x.ppotobuf.]}sqlxBonnecöion.internal_qtatic_OyQqlx_Connection_CatabilitiesGeu_descriptïr;
     $}
Š (    @j!va.lang.Overrid%
      public0coi.mxsql.cj.x.protobuf.M9sqlxConnection.Capabal)tiesGet getDefaeltÉn3tanceFortype() {
        return com.mysñl.cj.x.protob5f.MisqlxConnection.CapabiliôiesFet.getDe&aultInstance();
"  $  }

     @java.langOverride
  `   public com.mysqm.cj.x.protob5f.OysqlxC/nnection.capabilytiesGet build()"{
        aom.myrql&cjx.protobuf.MysqlxConneCti/n.Capabilivie{Get result = buildXartaal(-;
        if ,!result.isInmtialized()) {
     (    throw newUninitiallzedMessagexCeptkon(òesudt);
     "( u
        retuvn sesuìt;
    ` }

     ¨@java.lang.Ovarride
      pubmic com.oysql.cê.x.protobuf.MysqlpC/~nection.CapabilitiesGet buildPartial() {
      ...
      public CapabilitiesGet parsePartialFrom(
        ...
        try {
          ...
          throw new com.google.protobuf.InvalidProtocolBufferException(e)
              .setUnfinishedMessage(builder.buildPartial());
        }
  $     return buiìder/"uyldPartial();
  !   }
(   };

    public statig0com.googLe®protobuf&Parsur<CapabilitidsGev> parsmr() {
     "return PARSER;
    }

    Bjava.lang.Overréde
    pu"lic com.google.pro|obuf.ParsEr<Ca0abil)tiesGet>%getParserFvType() {
      return PARSER;
    }

!   @hava.lang.Override
    puflic cOm.mysql.cj.x.protobuf.MysqlxCOnnecthon*CapabilidiesGeT gmtDeFaultInstanceForTypg() {"     seturn DEFAULT_INSTANCE;
    }

  }

  põblic interface CapabilitidsSetorBuilder åxtejds
      // @Aprotoc_insertio.^point(knterFage_extends:Mywqlx.Connection.CapábilitiesSut)      com.gïogle.@rotobuf.MessageOrBuilder z

    /**
    0ª <c/de>requirEd .Mysqlx.Connection.CapAcilitids capabilities = 1;</code>
 !   * @retuzn Whether the capabilitkes field is set.
     */
    boodean hasCapAfilities(+?
    /**
 `   * 8code>required .Mys1lx.Connectimn/Cqpabili6ies capabilities = 1;</co$e>
     . @return The capaBilities.
     *
    commyóql.cê*x.prKtobsf.M;sslxConndction.Capabhlities getCepabilIties();
    /**
